...
class LinkCard(QFrame):
    ...
    def __init__(self, icon, title, content, url, parent=None):
        ...
        self.url = QUrl(url)
        self.setFixedSize(198, 220)# 设置大小
    ...
    def __initWidget(self):
        ...
        # self.iconWidget.setFixedSize(54, 54)# 设置icon大小
        self.iconWidget.setFixedSize(90, 90)  # 设置icon大小
        self.urlWidget.setFixedSize(16, 16)# 设置url大小
...
class LinkCardView(SingleDirectionScrollArea):
    ...
    def __init__(self, parent=None):
        ...
        self.hBoxLayout.setContentsMargins(36, 0, 0, 0) # 设置左边距
        self.hBoxLayout.setSpacing(12)  # 设置间距
