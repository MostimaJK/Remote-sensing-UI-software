...
class filterCard(QWidget):
    ...
    def __init__(self, title, widget: QWidget, sourcePath, stretch=0, parent=None):
        ...
        # 布局
        self.hBoxLayout = QHBoxLayout(self)  # 修改为水平布局
        self.cardLayout = QVBoxLayout(self.card)
        self.topLayout = QHBoxLayout()
        self.bottomLayout = QHBoxLayout(self.sourceWidget)
    ...
    # 初始化布局
    def __initLayout(self):
        self.hBoxLayout.setSizeConstraint(QHBoxLayout.SetMinimumSize)  # 修改为水平布局
        self.cardLayout.setSizeConstraint(QVBoxLayout.SetMinimumSize)
        self.topLayout.setSizeConstraint(QHBoxLayout.SetMinimumSize)

        self.hBoxLayout.setSpacing(12)  # 修改为水平布局
        self.hBoxLayout.setContentsMargins(0, 0, 0, 0)  # 修改为水平布局
        self.topLayout.setContentsMargins(12, 12, 12, 12)
        self.bottomLayout.setContentsMargins(18, 18, 18, 18)
        self.cardLayout.setContentsMargins(0, 0, 0, 0)

        self.hBoxLayout.addWidget(self.titleLabel, 0, Qt.AlignLeft)  # 修改为水平布局
        self.hBoxLayout.addWidget(self.card, 0, Qt.AlignLeft)  # 修改为水平布局
        self.hBoxLayout.setAlignment(Qt.AlignLeft)  # 修改为水平布局
...
class GalleryInterface(ScrollArea):
    ...
    # 添加一个示例卡片，包含了标签的翻译，标签对象，示例代码的链接，和拉伸值
    def addfilterCard(self, title, widget, sourcePath: str, stretch=0):
        card = filterCard(title, widget, sourcePath, stretch, self.view)
